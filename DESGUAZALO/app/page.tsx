...
export default function Home() {
  return (
    <div className="bg-[#f3f4ef] text-[#101214]">
      <section className="relative isolate overflow-hidden bg-[#0b0d0e] text-white">
        ...
        <div className="absolute -right-28 -top-24 -z-20 h-[520px] w-[520px] rotate-12 border-[86px] border-[#c8ff1a]/[.045]" />
        <div className="absolute -left-20 bottom-[-150px] -z-20 h-72 w-[560px] -skew-x-12 bg-[#ff5a2f]/[.045]" />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 pb-20 pt-16 sm:px-6 sm:pb-24 sm:pt-20 lg:grid-cols-[1.15fr_.85fr] lg:items-end lg:gap-20 lg:px-8 lg:pb-28 lg:pt-24">
          <div>
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#c8ff1a]/30 bg-[#c8ff1a]/10 px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-[.16em] text-[#d9ff67]">
            ...
            <h1 className="max-w-4xl text-[clamp(3.35rem,7vw,6.5rem)] font-black uppercase leading-[.9] tracking-[-0.055em] text-white">
              Encuentra la pieza.
              <br />
              <span className="text-[#c8ff1a]">Habla con quien la tiene.</span>
            </h1>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/marketplace"
                className="race-cut-sm inline-flex min-h-13 items-center justify-center bg-[#c8ff1a] px-6 text-sm font-black uppercase tracking-[.055em] text-[#101214] transition hover:bg-[#dcff6f]"
              >
          ...
          <div className="race-cut border border-white/12 bg-[#121516] p-6 shadow-[12px_12px_0_rgba(0,0,0,.22)] sm:p-7">
            <div className="flex items-center justify-between gap-4 border-b border-white/10 pb-4">
              <div>
                <p className="text-[10px] font-black uppercase tracking-[.18em] text-[#c8ff1a]">Cómo se usa</p>
            ...
            <div className="divide-y divide-white/10">
              {steps.map((step) => (
                <div key={step.number} className="grid grid-cols-[48px_1fr] gap-4 py-5">
                  <span className="font-racing text-2xl font-black italic text-[#c8ff1a]">{step.number}</span>
                  <div>
            ...
            <Link href="/marketplace" className="mt-2 inline-flex items-center text-sm font-black uppercase tracking-[.045em] text-white transition hover:text-[#c8ff1a]">
              Ver piezas disponibles <span className="ml-2 text-[#ff5a2f]">→</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section id="como-funciona" className="scroll-mt-24 border-b border-zinc-300 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[.75fr_1.25fr] lg:items-start">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[.18em] text-[#7b9000]">Lo esencial</p>
            ...
            <div className="grid gap-px overflow-hidden border border-zinc-300 bg-zinc-300 md:grid-cols-3">
              {steps.map((step) => (
                <article key={step.number} className="min-h-64 bg-[#f3f4ef] p-6 sm:p-7">
                  <span className="font-racing text-4xl font-black italic text-zinc-300">{step.number}</span>
                  <h3 className="mt-10 text-2xl font-black uppercase tracking-[-.03em] text-[#101214]">{step.title}</h3>
      ...
      <section className="border-b border-zinc-300 bg-[#e8eae4]">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="mb-9 max-w-2xl">
            <p className="text-[11px] font-black uppercase tracking-[.18em] text-[#7b9000]">Qué vas a encontrar</p>
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <Link href="/marketplace" className="group race-cut relative min-h-[330px] overflow-hidden bg-[#101214] p-7 text-white shadow-[8px_8px_0_#c8ff1a] transition hover:-translate-y-1 sm:p-9">
              <div className="absolute right-[-15px] top-[-45px] font-racing text-[11rem] font-black italic leading-none text-white/[.035]">01</div>
              <p className="relative text-[11px] font-black uppercase tracking-[.18em] text-[#c8ff1a]">Piezas individuales</p>
              ...
              <span className="relative mt-8 inline-flex items-center text-sm font-black uppercase tracking-[.045em] text-white group-hover:text-[#c8ff1a]">Explorar piezas <span className="ml-2 text-[#ff5a2f]">→</span></span>
            </Link>
            ...
            <Link href="/marketplace?type=vehicle" className="group race-cut relative min-h-[330px] overflow-hidden border border-zinc-300 bg-white p-7 shadow-[8px_8px_0_#d1d4cc] transition hover:-translate-y-1 sm:p-9">
              ...
              <p className="relative text-[11px] font-black uppercase tracking-[.18em] text-[#b64527]">Coches en despiece</p>
              <h3 className="relative mt-4 max-w-md text-4xl font-black uppercase leading-[.95] tracking-[-.04em] text-[#101214] sm:text-5xl">Encuentra un coche donante completo.</h3>
              ...
              <span className="relative mt-8 inline-flex items-center text-sm font-black uppercase tracking-[.045em] text-[#101214] group-hover:text-[#b64527]">Ver coches en despiece <span className="ml-2">→</span></span>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#101214] text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[.18em] text-[#c8ff1a]">Por qué DESGUÁZALO</p>
            ...
            <div className="divide-y divide-white/10 border-y border-white/10">
              {trustPoints.map(([title, text], index) => (
                <div key={title} className="grid gap-3 py-6 sm:grid-cols-[64px_180px_1fr] sm:items-start sm:gap-5">
                  <span className="font-racing text-2xl font-black italic text-[#c8ff1a]">{String(index + 1).padStart(2, "0")}</span>
      ...
      <section className="border-b border-zinc-300 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="race-cut overflow-hidden bg-[#c8ff1a] p-7 shadow-[10px_10px_0_#101214] sm:p-10 lg:grid lg:grid-cols-[1fr_auto] lg:items-end lg:gap-12">
            <div>
              <p className="text-[11px] font-black uppercase tracking-[.18em] text-black/55">También para vender</p>
              <h2 className="mt-3 max-w-3xl text-4xl font-black uppercase leading-[.92] tracking-[-.045em] text-[#101214] sm:text-6xl">¿Tienes piezas guardadas o un coche para despiece?</h2>
            ...
            <Link href="/publicar" className="race-cut-sm mt-8 inline-flex min-h-13 items-center justify-center bg-[#101214] px-6 text-sm font-black uppercase tracking-[.055em] text-white transition hover:bg-[#ff5a2f] lg:mt-0">
              Publicar una pieza
      ...
      <section className="bg-[#f3f4ef]">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-4 py-16 sm:px-6 sm:py-20 md:flex-row md:items-end lg:px-8">
          <div>
            <p className="text-[11px] font-black uppercase tracking-[.18em] text-[#7b9000]">Listo para buscar</p>
          ...
          <Link href="/marketplace" className="race-cut-sm inline-flex min-h-13 items-center justify-center bg-[#101214] px-7 text-sm font-black uppercase tracking-[.055em] text-white transition hover:bg-[#ff5a2f]">
            Ir al marketplace
            <span className="ml-2 text-lg">→</span>
          </Link>
        </div>
