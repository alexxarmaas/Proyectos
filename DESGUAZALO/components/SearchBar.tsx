  ...
  return (
    <form action="/marketplace" className={`race-cut flex w-full items-stretch overflow-hidden border border-white/12 bg-[#222723] shadow-[6px_6px_0_rgba(0,0,0,.2)] ${compact ? "max-w-3xl" : "max-w-4xl"}`}>
      <div className="flex min-w-0 flex-1 items-center gap-3 px-4">
        <svg viewBox="0 0 24 24" className="h-5 w-5 shrink-0 text-[#d1d8b5]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" aria-hidden="true">
      ...
      <button className="m-1.5 race-cut-sm bg-[#b6c18a] px-5 font-racing text-sm font-black uppercase italic tracking-[.05em] text-[#181b19] transition hover:bg-[#c5cda6] sm:px-6" type="submit">Buscar</button>
    </form>
  );
}
