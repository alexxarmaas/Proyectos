...
export function HeroSearch() {
  const fieldClass = "relative border border-white/10 bg-[#222723] px-4 py-3.5 transition focus-within:border-[#b6c18a]/70 focus-within:bg-[#282d29]";
  ...
  return (
    <form action="/marketplace" className="race-cut border border-white/12 bg-[#181b19] p-2 shadow-[12px_12px_0_rgba(0,0,0,.18)]">
      <div className="mb-2 flex items-center justify-between gap-3 px-2 py-1.5">
        <div className="flex items-center gap-2">
          <span className="h-2 w-2 bg-[#b6c18a]" />
      ...
      <div className="grid gap-2 lg:grid-cols-[1fr_1fr_1.4fr_auto]">
        ...
        <button type="submit" className="race-cut-sm flex min-h-16 items-center justify-center gap-2 bg-[#b6c18a] px-7 font-racing text-base font-black uppercase italic tracking-[.055em] text-[#181b19] transition hover:bg-[#c5cda6] lg:min-h-0">
