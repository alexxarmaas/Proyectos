...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-zinc-800 bg-[#141715] text-zinc-500">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1.4fr_.8fr_1fr] lg:px-8">
        <div className="space-y-4">
          ...
          <div className="flex gap-2 pt-1">
            <span className="race-cut-sm bg-[#b6c18a] px-2.5 py-1 font-racing text-[10px] font-black uppercase italic tracking-[.1em] text-[#181b19]">Used parts</span>
        ...
        <div className="space-y-3 text-sm">
          <p className="font-racing text-base font-black uppercase italic tracking-[.04em] text-zinc-100">Pit lane</p>
          <Link className="block transition hover:text-[#d1d8b5]" href="/marketplace">Buscar piezas</Link>
          <Link className="block transition hover:text-[#d1d8b5]" href="/marketplace?type=vehicle">Coches en despiece</Link>
          <Link className="block transition hover:text-[#d1d8b5]" href="/publicar">Publicar anuncio</Link>
        </div>

        <div className="space-y-3 text-sm">
          <p className="font-racing text-base font-black uppercase italic tracking-[.04em] text-zinc-100">Reglas del box</p>
      ...
      <div className="h-[2px] bg-[linear-gradient(90deg,#b6c18a_0_24%,#343935_24%_100%)]" />
    </footer>
  );
}
